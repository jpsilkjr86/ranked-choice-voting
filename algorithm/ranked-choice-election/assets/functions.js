...
function calculateRankedChoiceTallyResults({ startingTally, votesToCount, roundNum, results }) {
	...
	if (lowestScoreCandidates.length > 1) {
		...
		const runoff = createRunoff(lowestScoreCandidates, getAllBallotsInTally());
